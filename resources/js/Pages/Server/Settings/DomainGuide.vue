    ...
    <div class="flex relative z-0">
      ...
      <div class="flex-1 p-8 relative z-0 transition-all duration-300">
        <div class="max-w-3xl mx-auto py-10 px-4">
          <h1 class="text-3xl font-bold text-white mb-4">도메인 등록/가이드</h1>
          <p class="text-white/70 mb-8">도메인 등록 방법 및 안내를 입력하세요.</p>
          <form class="space-y-6">
            <div>
              <label class="block text-white/80 mb-1">도메인 등록 안내</label>
              <textarea class="w-full bg-white/10 border border-white/20 rounded-lg text-white p-3" rows="6" placeholder="도메인 등록 방법, 네임서버 안내, 주의사항 등"></textarea>
            </div>
